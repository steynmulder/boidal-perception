...
df['X_Differences'], df['Y_Differences'] = zip(*df['Data'].apply(compute_differences))
...
# Plot XY differences
ax1.scatter(timestamps_repeated, x_differences, color='blue', label='Error in x-position')

# Plot ZW differences
ax2.scatter(timestamps_repeated, y_differences, color='orange', label='Error in y-position')
